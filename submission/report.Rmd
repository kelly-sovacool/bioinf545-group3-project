...
Shannon diversity index of the 16S bacterial abundance data showed a general decreasing trend along the progression from healthy, adenoma, to cancer (Fig. \ref{fig:diversity}A). 
...
In contrast to Shannon diversity, Bray-Curtis distance is a beta diversity metric that quantifies diversity between communities.
...
This discrepancy in the number of features as inputs to the random forest model may have contributed to the bacterial model outperforming the viral model for classifying samples as healthy or cancerous.
