...
Moreover, higher abundance of Proteobacteria and lower abundance of Bacteroidetes in some patients with adenoma or carcinoma as compared to healthy patients in this study also demonstrate previous findings by Shen *et al.* [@shen_molecular_2010]. 

Gene abundance analysis using the metagenomes from patients indicated enrichment in genes and pathways previously shown to be associated with colorectal cancer.
