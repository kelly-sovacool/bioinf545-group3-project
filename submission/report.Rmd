...
\todo{caption for the diversity plot and describe results}
Shannon diversity showed a general decreasing trend along the progression from healthy, adenoma, to cancer (Fig. \ref{fig:diversity}).
...
\begin{wrapfigure}{r}{0.4\textwidth}
    \begin{center}
        ...
        \caption{Model performance as measured by the receiver operating characteristic (ROC) curve for models trained on 16S bacterial OTU abundance or virus OVU abundance.}
        \label{fig:auroc}  
    \end{center}
\end{wrapfigure}
